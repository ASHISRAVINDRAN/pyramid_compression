...
from LoadModel_gram import LoadModel
from LoadModel_gram import Load_BigModel
...
print ('STAGE1')
trainloss_to_file,testloss_to_file,Parameters=Train_stage1_GD(model,optimizer,Trainloader,Testloader,epochs=1,Train_mode=train_mode,
